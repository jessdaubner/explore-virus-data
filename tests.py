...
from process_virus_scan_data import format_date_utc, calculate_detections_by_vendors, VENDORS
...
def test_format_date_utc_from_timezone():
    ...
    assert format_date_utc(timestamp, "US/Central") == datetime(2022, 1, 3, 20, 30, 4, tzinfo=utc)
